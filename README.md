...
The data used for this project can be found in data/cell_data.csv. Further details regarding the process used to collect the data can be found in the paper. 
